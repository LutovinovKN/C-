...
{
    if (((value % (Convert.ToInt32(Math.Pow(10, digitCount))) /
    (Convert.ToInt32(Math.Pow(10, digitCount - 1))))) ==
    (value % (Convert.ToInt32(Math.Pow(10, i) /
    (Convert.ToInt32(Math.Pow(10, i - 1)))))))
    {
        a = 1;
    }
    else
